...
[SQL Analysis (Code)](https://github.com/Nirrmitt/Hospital-Mortality-Prediction-/blob/main/Hospital_Mortality_SQL_Analysis.sql)

[Hospital Mortality Dashboard on Tableau](https://github.com/Nirrmitt/Hospital-Mortality-Prediction-/blob/main/Hospital%20Mortality%20Dashboard%20(Tableau).png)
...
This output showed the number of patients who died and survived in each age group, categorized by 10-year intervals. There were far more admitted patients between the ages of 50-89 compared to patients who were between 0-49. Observing the results more, we can see that patients between ages 0-9 had the highest death percentage, and each 10-year age group in the 50-89 range had a slight increase in death percentage. Nearly 1 in every 6 patients between the ages of 70-89 died in the hospital. 
...
Average weight, BMI, and max heart rate among the patients who died. 
